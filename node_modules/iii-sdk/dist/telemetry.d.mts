...
//#endregion
export { type ConnectionStateCallback, DEFAULT_BRIDGE_RECONNECTION_CONFIG, DEFAULT_INVOCATION_TIMEOUT_MS, EngineFunctions, EngineTriggers, type FunctionInfo, type FunctionInfo as FunctionMessage, type FunctionsAvailableCallback, type IIIConnectionState, type IIIReconnectionConfig, type LogCallback, type LogConfig, LogFunctions, type LogSeverityLevel, type Meter, type OtelConfig, type OtelLogEvent, type Logger as OtelLogger, SeverityNumber, type Span, SpanStatusCode, type WorkerGaugesOptions, type WorkerInfo, type WorkerMetrics, WorkerMetricsCollector, type WorkerStatus, currentSpanId, currentTraceId, extractBaggage, extractContext, extractTraceparent, getAllBaggage, getBaggageEntry, getLogger, getMeter, getTracer, initOtel, injectBaggage, injectTraceparent, registerWorkerGauges, removeBaggageEntry, safeStringify, setBaggageEntry, shutdownOtel, stopWorkerGauges, withSpan };
