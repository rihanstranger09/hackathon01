...
Our logistic regression model (with TF-IDF) achieves ~97% accuracy and classifies input as:
...
├── phishing\_combined\_model.pkl # Trained ML model (Logistic Regression)
├── vectorizer\_vocab.json # Lightweight TF-IDF vocabulary for deployment
...
└── sample\_suspicious\_email.txt # Demo input file: Suspicious email
